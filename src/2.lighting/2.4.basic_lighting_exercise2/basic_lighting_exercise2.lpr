program basic_lighting_exercise2;
...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('2.4.basic_lighting.vs', '2.4.basic_lighting.fs');
  lightCubeShader := TShader.Create('2.4.light_cube.vs', '2.4.light_cube.fs');
