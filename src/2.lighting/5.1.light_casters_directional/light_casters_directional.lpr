program light_casters_directional;
...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('5.1.light_casters.vs', '5.1.light_casters.fs');
  lightCubeShader := TShader.Create('5.1.light_cube.vs', '5.1.light_cube.fs');
