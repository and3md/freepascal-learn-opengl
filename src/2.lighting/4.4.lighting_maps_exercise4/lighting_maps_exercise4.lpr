program lighting_maps_exercise4;
...
var
  ...
  diffuseMap, specularMap, emissionMap: GLuint;
...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('4.4.lighting_maps.vs', '4.4.lighting_maps.fs');
  lightCubeShader := TShader.Create('4.4.light_cube.vs', '4.4.light_cube.fs');
