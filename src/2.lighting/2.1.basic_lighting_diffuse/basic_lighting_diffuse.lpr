program basic_lighting_diffuse;
...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('2.1.basic_lighting.vs', '2.1.basic_lighting.fs');
  lightCubeShader := TShader.Create('2.1.light_cube.vs', '2.1.light_cube.fs');
