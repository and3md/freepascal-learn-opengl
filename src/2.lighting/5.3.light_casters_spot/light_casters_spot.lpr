...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('5.3.light_casters.vs', '5.3.light_casters.fs');
  lightCubeShader := TShader.Create('5.3.light_cube.vs', '5.3.light_cube.fs');
