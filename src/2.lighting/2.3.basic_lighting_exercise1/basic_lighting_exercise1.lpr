program basic_lighting_exercise1;
...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('2.2.basic_lighting.vs', '2.2.basic_lighting.fs');
  lightCubeShader := TShader.Create('2.2.light_cube.vs', '2.2.light_cube.fs');
  ...
  begin
    ...
    lightPos.data[0] := 1.0 + sin(glfwGetTime()) * 2.0;
    lightPos.data[1] := sin(glfwGetTime() / 2.0) * 1.0;
