...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('4.1.lighting_maps.vs', '4.1.lighting_maps.fs');
  lightCubeShader := TShader.Create('4.1.light_cube.vs', '4.1.light_cube.fs');
