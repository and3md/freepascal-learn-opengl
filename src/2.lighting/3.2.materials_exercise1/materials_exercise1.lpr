...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('3.2.materials.vs', '3.2.materials.fs');
  lightCubeShader := TShader.Create('3.2.light_cube.vs', '3.2.light_cube.fs');
