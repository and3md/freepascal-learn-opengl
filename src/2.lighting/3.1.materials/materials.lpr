...
var
  ...
  lightColor: Tvector3_single;
  diffuseColor: Tvector3_single;
  ambientColor: Tvector3_single;
...
begin
  ...
  // -------------------------------------
  lightingShader := TShader.Create('3.1.materials.vs', '3.1.materials.fs');
  lightCubeShader := TShader.Create('3.1.light_cube.vs', '3.1.light_cube.fs');
  ...
  begin
    ...
    // light properties
    lightColor.data[0] := sin(glfwGetTime * 2.0);
    lightColor.data[1] := sin(glfwGetTime * 0.7);
    lightColor.data[2] := sin(glfwGetTime * 1.3);
    diffuseColor := lightColor * Vector3(0.5, 0.5, 0.5);  // decrease the influence
    ambientColor := diffuseColor * Vector3(0.2, 0.2, 0.2);  // low influence
