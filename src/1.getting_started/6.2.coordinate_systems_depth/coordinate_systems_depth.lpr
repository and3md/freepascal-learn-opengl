program coordinate_systems_depth;
...
begin
  ...
  // -------------------------------------
  ourShader := TShader.Create('6.2.coordinate_systems.vs', '6.2.coordinate_systems.fs');
  ...
  begin
    ...
    model := RotateMatrix4(model, Single(glfwGetTime), Vector3(0.5, 1.0, 0.0));
